# Informe de Ciberinteligencia — 2026-08-15 (UTC)

**TLP:CLEAR**

## 1. Cabecera

- **Fecha (UTC):** 2026-08-15 06:35:03
...
Intervalo real cubierto: difiere entre fuentes — 23.2 h en `cisa-kev`, 23.2 h en `threatfox`.
...
| `threatfox` | parcial | 4735 | 0 | 0 | sí |
| | ↳ campos por debajo de su umbral: `reference` al 9.4% | | | | |
...
- `familia_sin_entrada`: 63 de 89 familias

**Nivel indicador** — denominador: **4735 indicadores de ThreatFox**.

- `sin_atribucion`: 260 de 4735
...
Medida sobre las **1665 entradas KEV procesadas** en esta ejecución (2026-08-15), no proyectada:
