# Informe de Ciberinteligencia — 2026-08-13 (UTC)

**TLP:CLEAR**

## 1. Cabecera

- **Fecha (UTC):** 2026-08-13 07:24:14
...
**Cambio del periodo:** 769 indicadores nuevos y 3 reaparecidos, y 935 caídos.

Intervalo real cubierto: difiere entre fuentes — 24.0 h en `cisa-kev`, 24.0 h en `threatfox`.

## 3. Juicios clave

- **57 de las 82 familias observadas** no tienen entrada en ATT&CK. Es **posible** que esa parte del panorama activo corresponda a crimeware commodity, que el catálogo describe peor que el instrumental dirigido. *(confianza: media — medición propia sobre un catálogo con sesgo de cobertura conocido)*
...
*Las familias se observan en la ventana de 5 días que termina en 2026-08-13 07:24 UTC. La variación compara ese agregado con el de la ejecución anterior.*
...
De las **82 familias observadas**, **25** tienen entrada en ATT&CK. El porcentaje de cada técnica es la proporción de familias observadas cuyo mapeo la incluye, sobre el total de **82 familias observadas**.
...
| `T1016` System Network Configuration Discovery | 15 de las 82 familias observadas | 18% |
| `T1113` Screen Capture | 14 de las 82 familias observadas | 17% |
| `T1033` System Owner/User Discovery | 13 de las 82 familias observadas | 15% |
| `T1083` File and Directory Discovery | 13 de las 82 familias observadas | 15% |
| `T1057` Process Discovery | 13 de las 82 familias observadas | 15% |
| `T1112` Modify Registry | 11 de las 82 familias observadas | 13% |
| `T1106` Native API | 11 de las 82 familias observadas | 13% |
| `T1027` Obfuscated Files or Information | 10 de las 82 familias observadas | 12% |
...
| `threatfox` | correcta | 2800 | 0 | 0 | sí |
...
- `familia_sin_entrada`: 57 de 82 familias

**Nivel indicador** — denominador: **2800 indicadores de ThreatFox**.

- `sin_atribucion`: 242 de 2800
