# Informe de Ciberinteligencia — 2026-09-26 (UTC)

**TLP:CLEAR**

## 1. Cabecera

- **Fecha (UTC):** 2026-09-26 10:50:30
- **Modo del informe:** diferencial
- **Línea base vigente:** 2026-09-02 10:40:02 UTC
- **Intervalo real** (difiere entre fuentes):
  - `cisa-kev`: 23.7 h
  - `threatfox`: 23.7 h
- **Fuentes consultadas:** `cisa-kev` (correcta), `threatfox` (fallida)

### Cálculos no publicados en esta ejecución

- **No se publican los caídos de `threatfox`:** la fuente no alcanzó estado correcta (fallida), de modo que su diferencial no es publicable. Lo que sí se publica queda **sesgado en un solo sentido**: altas sí, bajas no.
...
| `CVE-2026-65660` ⏰ | Microsoft | SharePoint | Unknown | 2026-09-28 |
| `CVE-2026-67279` ⏰ | MikroTik | RouterOS | Unknown | 2026-09-28 |
| `CVE-2026-87902` ⏰ | WordPress | Core | Unknown | 2026-09-28 |
...
Ningún indicador de infraestructura de esta ejecución alcanza el umbral de confianza para elevarse al informe (30).

## 7. Recomendaciones y ventanas de decisión

1. **Priorizar el parcheo** de las 5 entradas KEV con plazo en los próximos 7 días: `CVE-2026-5430` (2026-09-27), `CVE-2026-71362` (2026-09-27), `CVE-2026-65660` (2026-09-28).
...
|---|---|---|---|---|---|
| `cisa-kev` | correcta | 1726 | 0 | 0 | sí |
| `threatfox` | fallida | 0 | 0 | 0 | sí |
...
**Nivel entrada KEV** — denominador: **1726 entradas KEV procesadas**.

- `producto_inespecifico`: 131 de 1726
- `producto_sin_clasificar`: 1063 de 1726


### Cobertura de la tabla de vectores de explotación

Medida sobre las **1726 entradas KEV procesadas** en esta ejecución (2026-09-26), no proyectada:

- **Con vector inferido:** 532 (30%)
- **Sin clasificar** (trabajo pendiente, alimenta la cola de abajo): 1063 (61%)
