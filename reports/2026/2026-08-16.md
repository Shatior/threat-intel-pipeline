# Informe de Ciberinteligencia — 2026-08-16 (UTC)

**TLP:CLEAR**

## 1. Cabecera

- **Fecha (UTC):** 2026-08-16 06:36:54
...
Intervalo real cubierto: difiere entre fuentes — 24.0 h en `cisa-kev`, 47.2 h en `threatfox`.
...
| `threatfox` | parcial | 4937 | 0 | 0 | sí |
| | ↳ campos por debajo de su umbral: `reference` al 7.7% | | | | |
...
- `familia_sin_entrada`: 64 de 89 familias

**Nivel indicador** — denominador: **4937 indicadores de ThreatFox**.

- `sin_atribucion`: 231 de 4937
