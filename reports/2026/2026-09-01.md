# Informe de Ciberinteligencia — 2026-09-01 (UTC)

**TLP:CLEAR**

## 1. Cabecera

- **Fecha (UTC):** 2026-09-01 11:07:39
...
- ⚠️ **Frescura de `threatfox`:** el intervalo real (47.8 h) supera el umbral de advertencia (36.0 h). Causa: la fuente no alcanzó estado `correcta` en esta ejecución.
...
Intervalo real cubierto: difiere entre fuentes — 22.4 h en `cisa-kev`, 47.8 h en `threatfox`.
...
| `49[.]232[.]241[.]195` | `ipv4-addr` | `threatfox` | 100 | VShell | — |
| `tosanstore[.]com` | `domain-name` | `threatfox` | 100 | Unknown Loader | — |
| `hxxps://vcd[.]sm188dvlv[.]icu/` | `url` | `threatfox` | 100 | Vidar | — |
| `vcwxkel0[.]get-echofree[.]com` | `domain-name` | `threatfox` | 100 | ClearFake | — |
...
| `threatfox` | parcial | 3236 | 0 | 0 | sí |
| | ↳ campos por debajo de su umbral: `reference` al 5.2% | | | | |
...
**Nivel familia** — denominador: **67 familias observadas**.

- `ambiguedad_candidatos`: 1 de 67 familias
- `familia_sin_entrada`: 44 de 67 familias

**Nivel indicador** — denominador: **3236 indicadores de ThreatFox**.

- `sin_atribucion`: 87 de 3236
...
Medida sobre las **1687 entradas KEV procesadas** en esta ejecución (2026-09-01), no proyectada:
