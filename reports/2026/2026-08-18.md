# Informe de Ciberinteligencia — 2026-08-18 (UTC)

**TLP:CLEAR**

## 1. Cabecera

- **Fecha (UTC):** 2026-08-18 06:39:26
...
Intervalo real cubierto: difiere entre fuentes — 23.8 h en `cisa-kev`, 4.0 días en `threatfox`.
...
1. **Priorizar el parcheo** de las 2 entradas KEV con plazo en los próximos 7 días: `CVE-2025-62593` (2026-08-20), `CVE-2026-68820` (2026-08-25).
...
|---|---|---|---|---|---|
| `cisa-kev` | correcta | 1666 | 0 | 0 | sí |
| `threatfox` | parcial | 5334 | 0 | 0 | sí |
...
**Nivel indicador** — denominador: **5334 indicadores de ThreatFox**.

- `sin_atribucion`: 335 de 5334

**Nivel entrada KEV** — denominador: **1666 entradas KEV procesadas**.

- `producto_inespecifico`: 129 de 1666
- `producto_sin_clasificar`: 1016 de 1666


### Cobertura de la tabla de vectores de explotación

Medida sobre las **1666 entradas KEV procesadas** en esta ejecución (2026-08-18), no proyectada:

- **Con vector inferido:** 521 (31%)
- **Sin clasificar** (trabajo pendiente, alimenta la cola de abajo): 1016 (60%)
